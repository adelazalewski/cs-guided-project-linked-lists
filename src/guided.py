class LinkedListNode:
    def __init__(self, value):
        self.value = value
        self.next = None #a variable to call to the next node/pointer/another instance of this class 
...
linked_list = LinkedListNode(3) #or head also this is a new instance of the class LinkedListNode
tail = linked_list
